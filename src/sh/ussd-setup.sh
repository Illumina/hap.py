...
export PATH=/illumina/development/haplocompare/hc-virtualenv/bin:/illumina/thirdparty/gcc/el6/gcc-4.9.2/bin:/illumina/thirdparty/cmake/cmake-2.8.12.2/bin:$PATH

export LD_LIBRARY_PATH=/illumina/thirdparty/gcc/el6/gcc-4.9.2/lib

...
# Disabled for v0.2.1-public -- the counts that come out are approximately the same
...
# diff -I hap.py ${TMP_OUT}.pass.summary.csv ${DIR}/../../example/happy/expected.pass.summary.csv
# if [[ $? != 0 ]]; then
# 	echo "PASS summary differs! -- diff ${TMP_OUT}.pass.summary.csv ${DIR}/../../example/happy/expected.pass.summary.csv"
# 	exit 1
# fi
